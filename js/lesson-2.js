...
// }
// console.log(caclculateAverage(0, 5, 7, 8, 2,"12","wer"));
...
// console.log(totalNumber(someArr));
...
//     return strMax;
// }
// console.log(foo("Londonasdsad is the capital of Great Britain")); // 'capital'
...
// read(a, b) - приймає два аргумента і зберігаєїх як властивості об'єкта,
...
// *не забудь додати перевірку, якщо контакт з таким ім'ям чи імейлом вже є -
// ми його не додаємо
...
// updateName(oldName, newName) - зиінює ім'я контакта;
 ...
 const phonebook = {
    contacts: [],
     ...
     delete(name) {
         for (const item of this.contacts) {
             if (name === this.contacts[item].name) {
